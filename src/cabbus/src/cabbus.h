...
#define CABBUS_ATMEGA_USART0_SIMPLE
#define CABBUS_UART_RX_INTERRUPT    USART0_RXC_vect
#define CABBUS_UART_TX_INTERRUPT    USART0_UDRE_vect
#define CABBUS_UART_DONE_INTERRUPT  USART0_TXC_vect
#define CABBUS_PORT                 PORTD
#define CABBUS_PIN                  PIND
#define CABBUS_DDR                  DDRD

#ifndef CABBUS_TXE
#define CABBUS_TXE                  2       /* PD2 */
#endif
#ifndef CABBUS_TX
...
#define CABBUS_UART_UBRR            UBRR0L
...
#define CABBUS_ATMEGA_USART_SIMPLE
#define CABBUS_UART_RX_INTERRUPT    USART_RXC_vect
#define CABBUS_UART_TX_INTERRUPT    USART_UDRE_vect
#define CABBUS_UART_DONE_INTERRUPT  USART_TXC_vect
#define CABBUS_PORT                 PORTD
#define CABBUS_PIN                  PIND
#define CABBUS_DDR                  DDRD
...
#define CABBUS_UART_UBRR            UBRRL
#define CABBUS_UART_CSR_A           UCSRA
#define CABBUS_UART_CSR_B           UCSRB
#define CABBUS_UART_CSR_C           UCSRC
#define CABBUS_UART_DATA            UDR
#define CABBUS_UART_UDRIE           UDRIE
#define CABBUS_RXEN                 RXEN
#define CABBUS_TXEN                 TXEN
#define CABBUS_RXCIE                RXCIE
#define CABBUS_TXCIE                TXCIE
#define CABBUS_TXC                  TXC
#define CABBUS_RX_ERR_MASK          (_BV(FE) | _BV(DOR))
...
#define CABBUS_ATMEGA_USART
#define CABBUS_UART_RX_INTERRUPT    USART_RX_vect
#define CABBUS_UART_TX_INTERRUPT    USART_UDRE_vect
#define CABBUS_UART_DONE_INTERRUPT  USART_TX_vect
#define CABBUS_PORT                 PORTD
#define CABBUS_PIN                  PIND
#define CABBUS_DDR                  DDRD
...
#define CABBUS_UART_UBRRH          UBRRH
#define CABBUS_UART_UBRRL          UBRRL
#define CABBUS_UART_CSR_A          UCSRA
#define CABBUS_UART_CSR_B          UCSRB
#define CABBUS_UART_CSR_C          UCSRC
#define CABBUS_UART_DATA           UDR
